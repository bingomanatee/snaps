...
describe('SNAPS', function() {
    ...
    describe('Snap', function() {
        ...
        describe('Size', function() {
            ...
            describe('setting width to false', function() {
                var space;
                var size;
                before(function() {
                    space = SNAPS.space();
                ...
                describe('basic box', function() {
                    ...
                    before(function(done) {
                        dom.env(
                            ...
                            function(errors, window) {
                                window.document.innerWidth = 1024;
                    ...
                    describe('initial content%', function() {
                        it('should have html', function() {
                            space.document.innerHTML.should.eql('<html><body><div></div></body></html>');
                        });
                    });
                    ...
                    describe('width = 50%', function() {
                        ...
                        it('should react to document size change', function(){
                            ...
                            space.update();
                            space.document.innerHTML.should.eql('<html><body><div style="width: 300px;"></div></body></html>');
                        })
                    })
                });
            });
                    ...
                    describe('basic box', function() {
                        ...
                        describe('width = 50%', function() {
                            it('should assign 50px width to domSnap', function() {
                                ...
                                space.update();
                                space.document.innerHTML.should.eql('<html><body><div style="width: 200px;"><div style="width: 100px;"></div></div></body></html>');
                            });
                        })
                    });
                });
