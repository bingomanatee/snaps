...
[![Build Status](https://travis-ci.org/bingomanatee/pong.svg?branch=master)](https://travis-ci.org/bingomanatee/pong) [![Dependency Status](https://david-dm.org/bingomanatee/pong.svg)](https://david-dm.org/bingomanatee/pong) [![devDependency Status](https://david-dm.org/bingomanatee/pong/dev-status.svg)](https://david-dm.org/bingomanatee/pong#info=devDependencies)
